    ...
    switch(enType)
    {
        case PT_H264:
        {
            ...
            if(SAMPLE_RC_CBR == enRcMode)
            {
                ...
                stH264Cbr.u32SrcFrmRate      = 20;/* input (vi) frame rate */
                stH264Cbr.fr32DstFrmRate = 20;/* target frame rate */
            ...
            else if (SAMPLE_RC_VBR == enRcMode) 
            {
				...
				stH264Vbr.u32Gop =  20 * 5;
                stH264Vbr.u32StatTime = 1;
                stH264Vbr.u32SrcFrmRate = 20;
				stH264Vbr.fr32DstFrmRate = 20;
                stH264Vbr.u32MinQp = 32;//10;
                stH264Vbr.u32MaxQp = 48;//40;
                switch (enSize)
				{
					case PIC_QVGA:    /* 320 * 240 */
						stH264Vbr.u32MaxBitRate = 256;//512*3;
						break;
					case PIC_VGA:	   /* 640 * 480 */
						stH264Vbr.u32MaxBitRate = 512;//1024*2;
						break;
					case PIC_HD720:   /* 1280 * 720 */
						stH264Vbr.u32MaxBitRate = 768;//1024*3;
						break;
					case PIC_HD1080:  /* 1920 * 1080 */
						stH264Vbr.u32MaxBitRate = 1024;//1024*6;
						break;
					default :
