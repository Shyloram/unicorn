...
HI_CHAR* sensor_type = "ov9732";     // ov9732 ar0230 ar0130 imx222 9m034 ov9750 
...
/*zmodo sensor sc2235 reset*/
static HI_VOID sc2235_reset(void)
{
    //gpio7_4 set high                 
	...
	//osal_mdelay(2);
	//GPIO0_5
	himm(0x200f0004, 0x01);     
	himm (0x20140400, 0xa3);
	himm (0x20140080, 0x20);
	//osal_mdelay(20);
	//osal_mdelay(2);
	himm(0x20140080, 0x0);
	//osal_mdelay(20);
...
HI_VOID SDK_init(void)
{
    ...
    #ifndef CFG_INIT_SENSOR_IN_UBOOT
    SYS_cfg();
	#endif
