...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC2230_MIPI_2M_30FPS =
{
    {0, 0, 1920, 1080},
    {1920, 1080},
    30,
...
ISP_PUB_ATTR_S ISP_PUB_ATTR_SC3232_MIPI_3M_30FPS =
{
    {0, 0, 2304, 1296},
    {2304, 1296},
    30,
...
HI_S32 SAMPLE_COMM_ISP_GetIspAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, ISP_PUB_ATTR_S *pstPubAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_SC2230_MIPI_2M_30FPS_10BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_SC2230_MIPI_2M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;

        case SMART_SC3232_MIPI_3M_30FPS_10BIT:
            memcpy(pstPubAttr, &ISP_PUB_ATTR_SC3232_MIPI_3M_30FPS, sizeof(ISP_PUB_ATTR_S));
            break;
...
ISP_SNS_OBJ_S *SAMPLE_COMM_ISP_GetSnsObj(HI_U32 u32SnsId)
{
    ...
    switch (enSnsType)
    {
        ...
        case SMART_SC2230_MIPI_2M_30FPS_10BIT:
            return &stSnsSc2230Obj;

        case SMART_SC3232_MIPI_3M_30FPS_10BIT:
            return &stSnsSc3232Obj;
