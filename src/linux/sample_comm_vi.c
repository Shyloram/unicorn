...
combo_dev_attr_t MIPI_2lane_CHN0_SENSOR_SC3232_10BIT_3M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
combo_dev_attr_t MIPI_2lane_CHN1_SENSOR_SC3232_10BIT_3M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
combo_dev_attr_t MIPI_2lane_CHN0_SENSOR_SC2230_10BIT_2M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
combo_dev_attr_t MIPI_2lane_CHN1_SENSOR_SC2230_10BIT_2M_NOWDR_ATTR =
{
    .devno = 0,
    .input_mode = INPUT_MODE_MIPI,
    .data_rate = MIPI_DATA_RATE_X1,
...
VI_DEV_ATTR_S DEV_ATTR_SC2230_2M_BASE =
{
    VI_MODE_MIPI,
    VI_WORK_MODE_1Multiplex,
    {0xFFC00000,    0x0},
...
VI_DEV_ATTR_S DEV_ATTR_SC3232_3M_BASE =
{
    VI_MODE_MIPI,
    VI_WORK_MODE_1Multiplex,
    {0xFFC00000,    0x0},
...
HI_S32 SAMPLE_COMM_VI_GetComboAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, combo_dev_t MipiDev, combo_dev_attr_t *pstComboAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_SC2230_MIPI_2M_30FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_SC2230_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_SC2230_10BIT_2M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
        ...
        case SMART_SC3232_MIPI_3M_30FPS_10BIT:
            if (SAMPLE_COMM_VI_GetMipiLaneMode() == 1)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN0_SENSOR_SC3232_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            else if (SAMPLE_COMM_VI_GetMipiLaneMode() == 0)
            {
                hi_memcpy(pstComboAttr, sizeof(combo_dev_attr_t), &MIPI_2lane_CHN1_SENSOR_SC3232_10BIT_3M_NOWDR_ATTR, sizeof(combo_dev_attr_t));
            }
            break;
...
HI_S32 SAMPLE_COMM_VI_GetDevAttrBySns(SAMPLE_SNS_TYPE_E enSnsType, VI_DEV_ATTR_S *pstViDevAttr)
{
    switch (enSnsType)
    {
        ...
        case SMART_SC2230_MIPI_2M_30FPS_10BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC2230_2M_BASE, sizeof(VI_DEV_ATTR_S));
            break;

        case SMART_SC3232_MIPI_3M_30FPS_10BIT:
            hi_memcpy(pstViDevAttr, sizeof(VI_DEV_ATTR_S), &DEV_ATTR_SC3232_3M_BASE, sizeof(VI_DEV_ATTR_S));
            pstViDevAttr->au32ComponentMask[0] = 0xFFC00000;
            break;
