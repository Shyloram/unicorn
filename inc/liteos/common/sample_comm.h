...
typedef enum sample_vi_mode_e
{
	...
	OMNIVISION_OV2235_DC_1080P_20FPS,
    SAMPLE_VI_MODE_1_D1,
...
HI_S32 SAMPLE_COMM_VPSS_MemConfig(HI_VOID);
...
HI_S32 SAMPLE_COMM_VENC_StopGetStream(HI_VOID);
...
HI_S32 SAMPLE_COMM_AUDIO_DestoryAllTrd(HI_VOID);
...
HI_S32 SAMPLE_COMM_AUDIO_DisableAcodec(HI_VOID);
